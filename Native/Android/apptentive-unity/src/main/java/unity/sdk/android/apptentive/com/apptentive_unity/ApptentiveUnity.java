package unity.sdk.android.apptentive.com.apptentive_unity;
...
public final class ApptentiveUnity implements UnreadMessagesListener {
	public static boolean register(String configurationJson) {
		try {
	...
	public static int showMessageCenter() {
	...
	public static int engage(String event) {
